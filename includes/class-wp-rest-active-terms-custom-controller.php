 ...
 */
class WP_REST_Terms_Custom_Controller extends WP_REST_Controller {
	...
	public function __construct( $taxonomy ) {
		...
		$this->namespace = 'active_categories/v1';
	...
	public function get_items( $request ) {
		...
		foreach ( $query_result as $term ) {
			//alastor-added
			if(get_term_meta($term->term_id, 'show_in_custom_rest', true) === "yes"){
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 */
		return apply_filters( "rest_prepare_active_categories", $response, $item, $request );
	}
	...
	public function get_collection_params() {
		 ...
		 */
		return apply_filters( "rest_active_categories_collection_params", $query_params, $taxonomy );
	}
