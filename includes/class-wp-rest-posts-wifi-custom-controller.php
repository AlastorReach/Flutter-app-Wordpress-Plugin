<?php
class WP_REST_posts_wifi_custom_controller extends WP_REST_Posts_Controller {
...
function prefix_get_comment_schema() {
	...
	public function prepare_item_for_response( $post, $request ) {
		 ...
		 * @param WP_REST_Request  $request  Request object.
		 */
		return apply_filters( "rest_prepare_post_wifi", $response, $post, $request );
	}
